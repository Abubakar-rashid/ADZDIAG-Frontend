...
// Example placeholders (in real use, pull from DB)
$_SESSION['email'] = $_SESSION['email'] ?? "user@example.com";
$_SESSION['license_expiry'] = $_SESSION['license_expiry'] ?? "2025-12-31";
$_SESSION['contact_number'] = $_SESSION['contact_number'] ?? "+44 7700 900123";
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>User Settings - AdzDIAG</title>
        ...
        <div class="navbar">
          <div class="container-xl">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="licensing.php">Licensing</a>
              </li>
              <li class="nav-item active">
                <a class="nav-link active" href="usersetting.php">
        ...
        <div class="container-xl">
          <div class="card">
            <div class="card-body">
              ...
              <p><strong>License Expiry:</strong> <?php echo $_SESSION['license_expiry']; ?></p>
